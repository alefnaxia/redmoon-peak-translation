...
#define ROLE_NBEAST				"Владыка вампиров"
#define ROLE_BANDIT				"Разбойник"
#define ROLE_DELF				"Тёмный эльф"
#define ROLE_PREBEL				"Бунтарь"
#define ROLE_ASPIRANT			"Притязатель"
#define ROLE_LICH				"Лич"
#define ROLE_DREAMWALKER		"Сноходец"
#define ROLE_ASCENDANT			"Возносящийся"
#define ROLE_WRETCH				"Отверженный"
#define ROLE_UNBOUND_DEATHKNIGHT "Вольный рыцарь смерти"
#define ROLE_DARK_ITINERANT "Тёмный скиталец"
...
#define ROLE_NECRO_SKELETON		"Слуга некроманта"
#define ROLE_LICH_SKELETON		"Слуга Лича"
#define ROLE_CHOSEN				"Избранный"
#define ROLE_VAMPIRE_SUMMON		"Прислужник вампира"
