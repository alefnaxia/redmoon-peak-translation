...
/datum/sex_action/pitjob/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	...
	user.visible_message(sex_session.spanify_force("[user] [sex_session.get_generic_force_adjective()] придавливает пенис [target] к своей подмышке и двигает плечом..."))
